  ...
  <aside id="sidebar-wrapper">
    ...
    @if(auth()->user()->role == 'admin')
      <ul class="sidebar-menu">
        ...
        <li class="nav-item dropdown {{ request()->routeIs('branch.*') || request()->routeIs('kendaraan.*') || request()->routeIs('driver.*')? 'active' : '' }}">
          <a href="#" class="nav-link has-dropdown " data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Master Data</span></a>
          <ul class="dropdown-menu">
            <li class="{{ request()->routeIs('branch.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('branch.index') }}">Data Cabang</a></li>
